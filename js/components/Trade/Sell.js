  ...
  renderMessage = message => {
    ...
    return (
      ...
      >
        <View
          style={
            messageUserId === this.props.user.id ? styles.me : styles.trader
          }
        >
          ...
          >
            {message.item.body.length ? (
              ...
              <Image
                ...
                source={{
                  uri: "http://91.228.155.81" + message.item.attachment.url
                }}
              />
            )}
          </View>
          <Text style={{ fontSize: 12, marginTop: 5, color: "grey" }}>
            {moment(message.item.date).format("LT")} (MSK)
          </Text>
        </View>
      </View>
    );
    ...
    return (
      ...
      >
        <View style={this.state.showKeyboard ? styles.displayNone : null}>
          ...
          >
            ...
            <Text style={{ marginLeft: 10 }}>
              {User.approximateTradesCount(
                this.props.user.completed_trades_count
              )}
            </Text>
          </TouchableOpacity>
          ...
          <Text style={{ textAlign: "center" }}>
            Your request Trader {this.props.partnerName} PURCHASE ONLINE
            cryptocurrency from {this.props.createdAt}
          </Text>
          ...
          >
            ...
            <Text>
              <EscrowTimer expiredAt={this.props.trade.escrow_expired_at} /> min
            </Text>
          </View>
        </View>
        <View
          style={{
            height: !this.state.expandChat
        ...
        >
          <TouchableOpacity
            onPress={() =>
              this.setState({ expandChat: !this.state.expandChat })
            }
          >
            <View
              style={{
          ...
          <TextInput
            style={
              this.state.expandChat
                ? [styles.displayNone, { height: 30 }]
                : null
            }
        ...
        <View
          style={
            this.state.showKeyboard ? styles.displayNone : styles.bottomButtons
          }
        >
          {["paid_confirmed", "expired_and_paid"].includes(
            this.props.trade.status
          ) && (
            <PrimaryButton
